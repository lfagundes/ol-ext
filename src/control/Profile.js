...
inherits(ol_control_Profil, Control);
...
ol_control_Profil.prototype.setGeometry = function (g, options) {
    if (!options) options = {};
    if (g instanceof Feature) g = g.getGeometry();
    ...
    // TODO: replace ol_Sphere with ol getDistance
    ...
    function dist2d(p1, p2) {
        return wgs84Sphere.haversineDistance(
            transform(p1, proj, 'EPSG:4326'),
            transform(p2, proj, 'EPSG:4326'));
    }
