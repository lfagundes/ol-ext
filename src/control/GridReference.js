 ...
 *    - style {Style} Style to use for drawing the grid (stroke and text), default black.
...
inherits(ol_control_GridReference, Control);
...
ol_control_GridReference.prototype.drawGrid_ = function (e) {
    ...
    var map = this.getMap();
    var ex = boundingExtent([map.getPixelFromCoordinate([extent[0], extent[1]]), map.getPixelFromCoordinate([extent[2], extent[3]])]);
    var p0 = [ex[0], ex[1]];
    var p1 = [ex[2], ex[3]];
