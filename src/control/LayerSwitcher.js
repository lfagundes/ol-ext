...
inherits(ol_control_LayerSwitcher, Control);
...
ol_control_LayerSwitcher.prototype.drawList = function (ul, collection) {
    ...
    for (var i = layers.length - 1; i >= 0; i--) {
        ...
        else if (layer instanceof VectorLayer) li.addClass('ol-layer-vector');
        else if (layer instanceof VectorTileLayer) li.addClass('ol-layer-vector');
        else if (layer instanceof TileLayer) li.addClass('ol-layer-tile');
        else if (layer instanceof ImageLayer) li.addClass('ol-layer-image');
        else if (layer instanceof Heatmap) li.addClass('ol-layer-heatmap');
    }
