...
inherits(ol_control_Target, Control);
...
ol_control_Target.prototype.drawTarget_ = function (e) {
    ...
    var geom = new Point(this.getMap().getCoordinateFromPixel([cx, cy]));
    ...
    for (var i = 0; i < this.style.length; i++) {
        ...
        if (style instanceof Style) {
            ...
            var imgs = Map.prototype.getFeaturesAtPixel ? false : style.getImage();
            if (imgs) {
                sc = imgs.getScale();
